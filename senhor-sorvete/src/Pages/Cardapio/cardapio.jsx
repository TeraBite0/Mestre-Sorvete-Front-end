...
const Cardapio = () => {
    ...
    const fetchProdutos = async () => {
      ...
      try {
        const response = await axios.get(
          "http://10.0.0.26:80/api/produtos/ativos"
        );
  ...
  //   try {
  //     const response = await axios.get("http://10.0.0.26:80/api/produtos/populares");
  ...
  //     try {
  //       const response = await axios.post("http://10.0.0.26:80/api/notificacoes", {
  //         email,
  //         idProduto: item.id,
  //       });
