...
const Cardapio = () => {
    ...
    const fetchProdutos = async () => {
      ...
      try {
        const response = await axios.get(
          "http://50.19.70.8:80/api/produtos/ativos"
        );
  ...
  //   try {
  //     const response = await axios.get("http://50.19.70.8:80/api/produtos/populares");
  ...
  //     try {
  //       const response = await axios.post("http://50.19.70.8:80/api/notificacoes", {
  //         email,
  //         idProduto: item.id,
  //       });
