...
const Cardapio = () => {
    ...
    const fetchProdutos = async () => {
      ...
      try {
        const response = await axios.get(
          "http://54.243.180.4:80/api/produtos/ativos"
        );
  ...
  //   try {
  //     const response = await axios.get("http://54.243.180.4:80/api/produtos/populares");
  ...
  //     try {
  //       const response = await axios.post("http://54.243.180.4:80/api/notificacoes", {
  //         email,
  //         idProduto: item.id,
  //       });
