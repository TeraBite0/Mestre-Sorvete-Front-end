...
const ListarProdutos = () => {
    ...
    const buscarProdutos = async () => {
        ...
        try {
            ...
            const resposta = await fetch('http://54.80.52.5:80/api/produtos', {
                headers: {
    ...
    const adicionarNovaMarca = async () => {
        ...
        try {
            const response = await fetch('http://54.80.52.5:80/api/marcas', {
                method: 'POST',
                headers: {
    ...
    const adicionarNovoTipo = async () => {
        ...
        try {
            const response = await fetch('http://54.80.52.5:80/api/tipos', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
    ...
    const adicionarNovoSubtipo = async () => {
        ...
        try {
            const response = await fetch('http://54.80.52.5:80/api/subtipos', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
    ...
    //     const token = sessionStorage.getItem('token');
    //     const resposta = await fetch('http://54.80.52.5:80/api/azure', {
    //         method: 'GET',
    //         headers: {
    //             'Authorization': `Bearer ${token}`
    //         }
    ...
    const filtroPesquisa = async (termo) => {
        ...
        try {
            ...
            const response = await fetch(`http://54.80.52.5:80/api/produtos/filtrar-nome-marca?termo=${termoNormalizado}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const abrirModal = async () => {
        ...
        try {
            const urls = [
                { key: "marcas", url: "http://54.80.52.5:80/api/marcas" },
                { key: "subtipos", url: "http://54.80.52.5:80/api/subtipos" },
                { key: "tipos", url: "http://54.80.52.5:80/api/tipos" }
            ];
    ...
    const uploadImagem = async (produtoFormatado) => {
        ...
        try {
            const resposta = await fetch('http://54.80.52.5:80/api/images/produto/upload', {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                },
    ...
    const atualizarProduto = async (produto, dadosAtualizados) => {
        try {
            ...
            const resposta = await fetch(`http://54.80.52.5:80/api/produtos/${produto.id}`, {
                method: "PUT",
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${token}`
    ...
    const handleToggleAtivo = async (produto) => {
        ...
        try {
            const response = await fetch(`http://54.80.52.5:80/api/produtos/ativar/${produto.id}?isAtivo=${isAtivoGenerico}`, {
                method: "PATCH",
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${token}`
