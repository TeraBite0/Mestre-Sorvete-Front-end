  ...
  const handleSubmitAdicionar = async () => {
    ...
    try {
      ...
      if (response.data) {
        ...
        const vendasAtualizadas = agruparVendasPorData([
          ...rows,
          response.data,
        ]);
  ...
  return (
    <div className="container-vendas">
      ...
      <Dialog open={openBuscar} onClose={handleCloseBuscar}>
                        ...
                        <div>
                          ...
                          <ul>
                            {venda.produtos?.map((item, index) => (
                              <li key={index}>
                                {item.produto?.nome} - {item.qtdVendida}{" "}
                                unidades
                              </li>
                            ))}
                          </ul>
        ...
        <DialogActions>
          <Button className="botaoModal" onClick={handleCloseBuscar}>
            Fechar
          </Button>
          <Button className="botaoModal" onClick={handleSubmitBuscar}>
            Buscar
          </Button>
        </DialogActions>
      </Dialog>
