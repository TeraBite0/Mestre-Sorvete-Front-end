...
const Recomendacoes = () => {
    ...
    const buscarTodosProdutos = async () => {
        ...
        try{
            ...
            const resposta = await fetch('http://10.0.0.25:8080/produtos/ativos', {
                headers: {
    ...
    const buscarProdutos = async () => {
        ...
        try {
            // Buscar todos os Produtos
            const resposta = await fetch('http://10.0.0.25:8080/produtos/recomendacao', {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const atualizarRecomendacao = async (produto, idRecomendacao) => {
        ...
        try {
            ...
            const resposta = await fetch(`http://10.0.0.25:8080/produtos/recomendacao/${idRecomendacao}`, {
                method: "PUT",
                headers: {
