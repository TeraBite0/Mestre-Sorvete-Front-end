...
const Recomendacoes = () => {
    ...
    const buscarTodosProdutos = async () => {
        ...
        try {
            ...
            const resposta = await fetch('http://54.80.52.5:80/api/produtos/ativos', {
                headers: {
    ...
    const buscarProdutos = async () => {
        ...
        try {
            // Buscar todos os Produtos
            const resposta = await fetch('http://54.80.52.5:80/api/produtos/recomendacao', {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const atualizarRecomendacao = async (produto, idRecomendacao) => {
        ...
        try {
            ...
            const resposta = await fetch(`http://54.80.52.5:80/api/produtos/recomendacao/${idRecomendacao}`, {
                method: "PUT",
                headers: {
