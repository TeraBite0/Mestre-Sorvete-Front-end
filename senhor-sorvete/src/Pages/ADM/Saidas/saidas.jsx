...
const Saidas = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://10.0.0.26:8080/api/saidas-estoque", {
        headers: {
  ...
  const handleOpenAdicionar = async () => {
    ...
    try {
      const response = await axios.get("http://10.0.0.26:8080/api/produtos", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleConfirmarSaida = async (novasSaidas) => {
    ...
    try {
      ...
      await axios.post("http://10.0.0.26:8080/api/saidas-estoque", saidaEstoque, {
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  const handleSubmitBuscar = async () => {
    ...
    try {
      ...
      const response = await axios.get("http://10.0.0.26:8080/api/saidas-estoque/data", {
  ...
  const handleConfirmarEdicaoSaida = async (editarSaida) => {
    ...
    try {
      await axios.put(`http://10.0.0.26:8080/api/saidas-estoque/${saidaEditada.id}`, saidaEditada, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleDeletar = async () => {
    ...
    try {
      await axios.delete("http://10.0.0.26:8080/api/saidas-estoque", {
