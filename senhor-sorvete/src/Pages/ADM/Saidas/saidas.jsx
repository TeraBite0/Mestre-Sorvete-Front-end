...
const Saidas = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://34.207.75.40:80/api/saidas-estoque", {
        headers: {
  ...
  const handleConfirmarSaida = async (novasSaidas) => {
    ...
    try {
      ...
      await axios.post("http://34.207.75.40:80/api/saidas-estoque", saidaEstoque, {
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  const handleSubmitBuscar = async () => {
    ...
    try {
      ...
      const response = await axios.get("http://34.207.75.40:80/api/saidas-estoque/data", {
  ...
  const handleConfirmarEdicaoSaida = async (editarSaida) => {
    ...
    try {
      await axios.put(`http://34.207.75.40:80/api/saidas-estoque/${saidaEditada.id}`, saidaEditada, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleDeletar = async () => {
    ...
    try {
      await axios.delete("http://34.207.75.40:80/api/saidas-estoque", {
