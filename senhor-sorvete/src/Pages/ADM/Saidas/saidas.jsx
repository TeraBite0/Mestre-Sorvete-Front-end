...
const Saidas = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://mestre-sorvete-back-end.onrender.com/saidas-estoque", {
        headers: {
  ...
  const handleConfirmarSaida = async (novasSaidas) => {
    ...
    try {
      ...
      await axios.post("https://mestre-sorvete-back-end.onrender.com/saidas-estoque", saidaEstoque, {
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  const handleSubmitBuscar = async () => {
    ...
    try {
      ...
      const response = await axios.get("https://mestre-sorvete-back-end.onrender.com/saidas-estoque/data", {
  ...
  const handleConfirmarEdicaoSaida = async (editarSaida) => {
    ...
    try {
      await axios.put(`https://mestre-sorvete-back-end.onrender.com/saidas-estoque/${saidaEditada.id}`, saidaEditada, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleDeletar = async () => {
    ...
    try {
      await axios.delete("https://mestre-sorvete-back-end.onrender.com/saidas-estoque", {
