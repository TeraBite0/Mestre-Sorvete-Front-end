...
const Recomendacoes = () => {
    ...
    const buscarTodosProdutos = async () => {
        ...
        try {
            ...
            const resposta = await fetch('https://mestre-sorvete-back-end.onrender.com/produtos/ativos', {
                headers: {
    ...
    const buscarProdutos = async () => {
        ...
        try {
            // Buscar todos os Produtos
            const resposta = await fetch('https://mestre-sorvete-back-end.onrender.com/produtos/recomendacao', {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const atualizarRecomendacao = async (produto, idRecomendacao) => {
        ...
        try {
            ...
            const resposta = await fetch(`https://mestre-sorvete-back-end.onrender.com/produtos/recomendacao/${idRecomendacao}`, {
                method: "PUT",
                headers: {
