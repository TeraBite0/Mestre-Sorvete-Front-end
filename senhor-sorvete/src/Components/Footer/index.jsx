    ...
    return (
        <div className='footer'>
            ...
            <div className='footer-content'>
                <div className='logo'>
                    <img src='/Imagens/logo-terabite.png' alt='Logo da empresa TeraBite' />
                </div>

                <div className='sobre-projeto'>
                    <p>Este projeto é resultado da dedicação e expertise da equipe TeraBite. Cada detalhe foi pensado com cuidado para proporcionar a melhor experiência aos nossos clientes.</p>
                </div>
